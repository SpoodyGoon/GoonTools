...
namespace SQLiteMonoPlusUI
{
	public partial class frmMain
	{
		...
		protected virtual void Build ()
		{
			...
			this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem name='NewQueryAction' action='NewQueryAction'/><toolitem name='ExecuteAction' action='ExecuteAction'/></toolbar></ui>");
