...
{
	public class ScriptToMenu : Gtk.Menu
	{
		public event Events.ScriptObjectToEventHandler ScriptToClicked;
		private DBObjectType _ObjectType;
		private object _DBSchemaObject;
		public ScriptToMenu(DBObjectType Type, object SchemaObject)
		{
			_ObjectType=Type;
			_DBSchemaObject = SchemaObject;
		...
		public void OnScriptToClicked (ScriptToAction action, ScriptToLocation location)
		{
			switch (_ObjectType)
			{
