...
namespace SQLiteMonoPlusUI.Editors.SQL
{
	...
	public class SQLEditorView : Gtk.TextView
	{
		...
		public event Events.SQLExecutedEventHandler SQLExecuted;
		public event Events.SQLModifiedEventHandler SQLChanged;
		public event Events.ConnectionChangeEventHandler ConnectionChanged;
...
//				}
		...
		protected override bool OnKeyReleaseEvent (Gdk.EventKey evnt)
		{
			...
			{
				case Gdk.Key.F5:
					SQLExecuted(this, new Events.SQLExecutedEventArgs(this.CurrentConnection, this.SQLSelectedText));
				break;
				case Gdk.Key.space:
				break;
				case Gdk.Key.Tab:
		...
		protected override bool OnButtonPressEvent (Gdk.EventButton evnt)
		{
			if (evnt.Button == 3)
			{
				ContexMenus.SQLEditorViewMenu mnu = new ContexMenus.SQLEditorViewMenu ();
				Gdk.Window win = this.ParentWindow;
				mnu.ShowAll ();
				mnu.ConnectChangeRequested += delegate()
				{
					ConnectionChanged (this, new Events.ConnectionChangeEventArgs (this.CurrentConnection));
...
//					md.Destroy();
		...
		{
			SQLExecuted (this, new Events.SQLExecutedEventArgs (_CurrentConnection, strSQL));
		}
	}
}
