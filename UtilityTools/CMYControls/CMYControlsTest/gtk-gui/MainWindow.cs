...
public partial class MainWindow {
    ...
    private Gtk.Alignment algQuickDate;
    
    private CMYControls.QuickDate quickdate1;
    ...
    protected virtual void Build() {
        ...
        this.algQuickDate = new Gtk.Alignment(0.5F, 0.5F, 1F, 1F);
        ...
        this.vbox2.Add(this.algQuickDate);
        Gtk.Box.BoxChild w7 = ((Gtk.Box.BoxChild)(this.vbox2[this.algQuickDate]));
        w7.Position = 0;
        w7.Expand = false;
        w7.Fill = false;
        ...
        Gtk.Box.BoxChild w10 = ((Gtk.Box.BoxChild)(this.vbox1[this.alignment3]));
        w10.Position = 2;
        // Container child vbox1.Gtk.Box+BoxChild
