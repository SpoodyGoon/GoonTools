...
public partial class MainWindow {
    ...
    private CMYControls.QuickTime quicktime1;
    ...
    protected virtual void Build() {
        ...
        this.label2.LabelProp = Mono.Unix.Catalog.GetString("<b>Column Selector</b>");
        ...
        this.quicktime1 = new CMYControls.QuickTime();
        this.quicktime1.Events = ((Gdk.EventMask)(256));
        this.quicktime1.Name = "quicktime1";
        this.vbox2.Add(this.quicktime1);
        Gtk.Box.BoxChild w7 = ((Gtk.Box.BoxChild)(this.vbox2[this.quicktime1]));
        w7.Position = 1;
        w7.Expand = false;
        w7.Fill = false;
        this.notebook1.Add(this.vbox2);
        Gtk.Notebook.NotebookChild w8 = ((Gtk.Notebook.NotebookChild)(this.notebook1[this.vbox2]));
        w8.Position = 1;
        // Notebook tab
        this.label3 = new Gtk.Label();
        this.label3.Name = "label3";
        this.label3.LabelProp = Mono.Unix.Catalog.GetString("<b>Quick DateTime</b>");
