...
namespace MonoBPMonitor {
    ...
    public partial class MainWindow {
        ...
        private Gtk.Action ThemesAction;
        
        private Gtk.Action UpdatesAction;
        
        private Gtk.Action UpdateOptionsAction;
        
        private Gtk.ToggleAction SystemAction;
        ...
        protected virtual void Build() {
            ...
            this.BackupRestoreAction = new Gtk.Action("BackupRestoreAction", Mono.Unix.Catalog.GetString("Backup/Restore"), null, null);
            this.BackupRestoreAction.ShortLabel = Mono.Unix.Catalog.GetString("Backup");
            ...
            this.ThemesAction = new Gtk.Action("ThemesAction", Mono.Unix.Catalog.GetString("Themes"), null, null);
            this.ThemesAction.ShortLabel = Mono.Unix.Catalog.GetString("Themes");
            ...
            this.UpdateOptionsAction = new Gtk.Action("UpdateOptionsAction", Mono.Unix.Catalog.GetString("Update Options"), null, null);
            this.UpdateOptionsAction.ShortLabel = Mono.Unix.Catalog.GetString("Update Options");
            w1.Add(this.UpdateOptionsAction, null);
            this.SystemAction = new Gtk.ToggleAction("SystemAction", Mono.Unix.Catalog.GetString("System"), null, null);
            this.SystemAction.ShortLabel = Mono.Unix.Catalog.GetString("System");
            ...
            this.UIManager.AddUiFromString(@"<ui><menubar name='menubar1'><menu name='FileAction' action='FileAction'><menuitem name='NewEntryAction' action='NewEntryAction'/><menuitem name='MedicationAction' action='MedicationAction'/><menuitem name='DoctorsAction' action='DoctorsAction'/><menuitem name='UsersAction' action='UsersAction'/><separator/><menuitem name='QuitAction' action='QuitAction'/></menu><menu name='ToolsAction' action='ToolsAction'><menuitem name='BackupRestoreAction' action='BackupRestoreAction'/><menu name='ThemesAction' action='ThemesAction'><menuitem name='SystemAction' action='SystemAction'/></menu><menu name='UpdatesAction' action='UpdatesAction'/></menu><menu name='HelpAction' action='HelpAction'><menuitem name='ErrorLogAction' action='ErrorLogAction'/><menuitem name='AboutAction' action='AboutAction'/></menu></menubar></ui>");
            ...
            this.BackupRestoreAction.Activated += new System.EventHandler(this.OnBackupActionActivated);
            ...
            this.SystemAction.Activated += new System.EventHandler(this.OnSystemActionActivated);
        }
    }
}
