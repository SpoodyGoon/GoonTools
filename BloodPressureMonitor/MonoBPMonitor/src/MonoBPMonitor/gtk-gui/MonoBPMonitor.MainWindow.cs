...
namespace MonoBPMonitor {
    ...
    public partial class MainWindow {
        ...
        private Gtk.Action EditEntryAction;
        
        private Gtk.Action RemoveEntryAction;
        ...
        protected virtual void Build() {
            ...
            this.EditEntryAction = new Gtk.Action("EditEntryAction", Mono.Unix.Catalog.GetString("Edit Entry"), null, "edit.png");
            this.EditEntryAction.ShortLabel = Mono.Unix.Catalog.GetString("Edit Entry");
            w1.Add(this.EditEntryAction, null);
            this.RemoveEntryAction = new Gtk.Action("RemoveEntryAction", Mono.Unix.Catalog.GetString("Remove Entry"), null, "edit_remove.png");
            this.RemoveEntryAction.ShortLabel = Mono.Unix.Catalog.GetString("Remove Entry");
            w1.Add(this.RemoveEntryAction, null);
