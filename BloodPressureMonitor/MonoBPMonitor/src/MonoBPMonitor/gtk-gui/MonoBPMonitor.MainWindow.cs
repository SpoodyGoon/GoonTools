...
namespace MonoBPMonitor {
    ...
    public partial class MainWindow {
        ...
        protected virtual void Build() {
            ...
            this.UIManager.AddUiFromString(@"<ui><menubar name='menubar1'><menu name='FileAction' action='FileAction'><menuitem name='NewEntryAction' action='NewEntryAction'/><menuitem name='MedicationAction' action='MedicationAction'/><menuitem name='DoctorsAction' action='DoctorsAction'/><menuitem name='UsersAction' action='UsersAction'/><menuitem name='QuitAction' action='QuitAction'/></menu><menu name='ToolsAction' action='ToolsAction'><menuitem name='BackupRestoreAction' action='BackupRestoreAction'/></menu><menu name='HelpAction' action='HelpAction'><menuitem name='ErrorLogAction' action='ErrorLogAction'/><menuitem name='AboutAction' action='AboutAction'/></menu></menubar></ui>");
