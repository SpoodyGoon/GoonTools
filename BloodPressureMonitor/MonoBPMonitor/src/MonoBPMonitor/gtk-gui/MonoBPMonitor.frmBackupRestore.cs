...
namespace MonoBPMonitor {
    ...
    public partial class frmBackupRestore {
        ...
        protected virtual void Build() {
            ...
            this.lblFeedBack = new Gtk.Label();
            this.lblFeedBack.Name = "lblFeedBack";
            this.lblFeedBack.Ypad = 2;
            this.lblFeedBack.Xalign = 0.05F;
            this.lblFeedBack.LabelProp = Mono.Unix.Catalog.GetString("<b>N/A</b>");
            this.lblFeedBack.UseMarkup = true;
            this.lblFeedBack.SingleLineMode = true;
            this.alignment6.Add(this.lblFeedBack);
            this.vbox2.Add(this.alignment6);
            Gtk.Box.BoxChild w29 = ((Gtk.Box.BoxChild)(this.vbox2[this.alignment6]));
            w29.Position = 5;
            w29.Expand = false;
            w29.Fill = false;
            this.alignment1.Add(this.vbox2);
            w1.Add(this.alignment1);
            Gtk.Box.BoxChild w31 = ((Gtk.Box.BoxChild)(w1[this.alignment1]));
            w31.Position = 0;
            w31.Expand = false;
            w31.Fill = false;
