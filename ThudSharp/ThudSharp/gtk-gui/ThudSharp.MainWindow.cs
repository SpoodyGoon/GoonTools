...
namespace ThudSharp {
    ...
    public partial class MainWindow {
        ...
        protected virtual void Build() {
            ...
            Gtk.Box.BoxChild w4 = ((Gtk.Box.BoxChild)(this.vbox3[this.drawingarea1]));
            w4.Position = 0;
            ...
            Gtk.Fixed.FixedChild w8 = ((Gtk.Fixed.FixedChild)(this.fixGameArea[this.gameboard1]));
            w8.X = 5;
            w8.Y = 5;
            this.GtkAlignment.Add(this.fixGameArea);
            this.frame1.Add(this.GtkAlignment);
            this.hbox1.Add(this.frame1);
            Gtk.Box.BoxChild w11 = ((Gtk.Box.BoxChild)(this.hbox1[this.frame1]));
            w11.Position = 2;
            w11.Expand = false;
            w11.Fill = false;
            ...
            Gtk.Box.BoxChild w13 = ((Gtk.Box.BoxChild)(this.stbMain[this.label3]));
            w13.Position = 1;
            w13.Expand = false;
            w13.Fill = false;
            this.vbox1.Add(this.stbMain);
            Gtk.Box.BoxChild w14 = ((Gtk.Box.BoxChild)(this.vbox1[this.stbMain]));
            w14.Position = 1;
            w14.Expand = false;
            w14.Fill = false;
            w14.Padding = ((uint)(2));
