...
// Description: wxGUPDlg class implementation
//
//---------------------------------------------------------------------------
...
////Event Table Start
BEGIN_EVENT_TABLE(wxGUPDlg,wxDialog)
	////Manual Code Start
	////Manual Code End
	
	EVT_CLOSE(wxGUPDlg::OnClose)
END_EVENT_TABLE()
////Event Table End

wxGUPDlg::wxGUPDlg(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &position, const wxSize& size, long style)
...
void wxGUPDlg::CreateGUIControls()
{
...
void wxGUPDlg::OnClose(wxCloseEvent& /*event*/)
{
	Destroy();
}
...
static size_t setProgress(HWND hProgress,	double t,
											double d, 
											double ultotal,
											double ulnow)
{
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR lpszCmdLine, int nCmdShow)
{
	...
	try {
		...
		::ShellExecuteA(NULL, "open", dlDest.c_str(), "", ".", SW_SHOW);
		return 0;
